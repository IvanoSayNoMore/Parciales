    ...
    do{
				...
				MAXIMOOPCION, REINTENTOS)==RETORNOPOSITIVO)
    	{
			...
			case 11:
				...
				{
					listaPorCodigoVuelo=ll_filter(listaPasajeros,controller_listaPorEstadoVuelo);
					if(controller_saveAsText("Codigos de vuelo BA2491A.csv",listaPorCodigoVuelo)==RETORNOPOSITIVO)
					{
